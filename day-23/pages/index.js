...
export default function Home() {
  ...
  return (
    <main className="flex flex-col h-screen justify-center items-center align-center bg-[url('../public/christmas.png')] font-mono text-white p-2">
      ...
      <article className="bg-green-600 space-y-4 pt-6 pb-3 px-6 border-2 border-white rounded-lg max-w-lg">
      ...
      <footer className=" bg-green-600 p-1 px-2 border-white border-2 rounded-full absolute bottom-1 font-bold text-center text-sm text-gray-200">
        <p>
          Made with ❤️ by{" "}
          <Link
      ...
      <div className="print:hidden">
        <Snowfall className="print:hidden" />
      </div>
    </main>
  );
}
